<template>
	<div class="body-wrap WrfPredict">
		<!--内容区域-->
				...
				<el-col :san="24" style="height: 100%;">
					<div class="imgContent">
						...
						<div class="top" @click="selectClick">
							...
							<el-breadcrumb   v-if="breadcrumbArr.length>0" separator-class="el-icon-arrow-right" style="line-height: 40px;float: left;margin-left: 10px;color: #fff;">
						...
						<div  class="selectExpand" v-show="isUpExpandShow" >
							<div v-for='item in selecteArr' class="expandDiv"  >
								...
								<div class="btnGroup">
								<el-radio-group v-model="item.default" v-if="item" @change="setImgObj">
							      <el-radio-button v-for="x in item.data" :label="x.value" :key="x.value" >
							    
							      	{{x.label}}</el-radio-button>
							    </el-radio-group>
							    </div>
							</div>
		...
		<right-panel :rightPanelWidth="rightPanelWidth" :toggleStatus="toggleStatus" @togglePanel="onTogglePanel">
			...
			<div class="condition-wrap">
				...
				<div class="con-div">
					<span class="con-label">-起报时间-</span>
					<div class="con-body">
						<el-date-picker
							style="width:160px"
							v-model="pDate"
					...
					<div class="con-body tabBtnStyle">
						<el-tabs type="border-card" @tab-click="handleClick" v-model="tabIndexName">
						  <el-tab-pane label="来源" name="first">
						  		 <el-radio-group v-model="source" v-if="source!=null"  @change="setImgObj" >
						  ...
						  <el-tab-pane label="要素" name="second">
						  		 <el-radio-group v-model="basic" v-if="basics.length>0" @change="setImgObj">
...
<style scoped>
	...
	.single{
	background:url(../../3ClearLz/control/ImageControl/image/L.png) no-repeat;
	}
	/*单站*/
	.oneStation{
